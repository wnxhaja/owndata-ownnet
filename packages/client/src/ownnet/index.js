...
const OwnnetClass = function (cls, opts) {
  let OwnnetParent = OwnClass(cls, opts);
  return class OwnnetClass extends OwnnetParent {
...
function init(cls, options) {
  return new OwnnetClass(cls, options);
}
 ...
 *
 */
function xownnetWrapper(clsapp, path, options = {}) {
...
const ownnetWrapper = (cls, opts) => { return new Ownnet(cls, opts) };
